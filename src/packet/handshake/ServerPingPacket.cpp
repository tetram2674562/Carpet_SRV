...
namespace packet {
ServerPingPacket::ServerPingPacket(unsigned char ping)
  : ping(ping)
{
}
...
void
ServerPingPacket::writeData(Buffer& buffer)
{
}

void
ServerPingPacket::readData(Buffer& buffer)
{
...
unsigned char
ServerPingPacket::getPing() const
{
  return ping;
}
}