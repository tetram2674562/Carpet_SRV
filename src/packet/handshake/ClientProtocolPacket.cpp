...
string ClientProtocolPacket::getUsername() { return this->username; }

string ClientProtocolPacket::getServerHost() { return this->serverHost; }

int ClientProtocolPacket::getServerPort() const { return this->serverPort; }
...
int ClientProtocolPacket::getSize() { return 3 + 2 * this->username.size(); }
